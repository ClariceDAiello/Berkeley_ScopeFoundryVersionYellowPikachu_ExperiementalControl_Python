'''
@author: Ed Barnard, Clarice Aiello
'''
...
class MeasurementComponent(QObject):
    ...
    def __init__(self, gui,sequence_filename):
        """type gui: BaseGUI
        """        
        self.name = sequence_filename

        self.gui = gui
        
        QObject.__init__(self,self.gui)
        
        self.operations = OrderedDict()
    
       # self.setup()
        
       # self._add_control_widgets_to_measurement_tab()
    ...
    def _add_control_widgets_to_measurement_tab(self):
       
        
        cwidget = self.gui.ui.measurement_tab_scrollArea_content_widget
        ...
        for lqname, lq in self.logged_quantities.items():
              ...
              if lq.displayFlag == True:
                ...
                if lq.choices is not None:
                    ...
                    widget = ScientificDoubleSpinBox() #pg.SpinBox()
                elif lq.dtype in [bool]:
                    widget = QCheckBox()  
                    widget.setChecked(lq.val)
